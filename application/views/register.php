    ...
    <div class="col-sm-10 col-sm-offset-1">
        <div class="danero-box">
            ...
            <div id="registration-steps">
                    ...
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            <div class="plan">
                                ...
                                <h2 class="bronze-text">Bronze</h2>
                ...
                <section>
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 vabc-box">
                            ...
                            <div class="form-group">
                                <label for="about-us">* Join Us Message</label>
                                <textarea id="about-us" class="form-control required" rows="4" maxlength="1000"></textarea>
                            </div>
                        </div>
